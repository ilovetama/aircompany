...
public class AirportTest {
    ...
    @Test
    public final void testGetTransportMilitaryPlanes() {
    ...
    @Test
    public final void testGetPassengerPlaneWithMaxCapacity() {
        Airport airport = new Airport(planes);
    ...
    @Test
    public final void testNextPlaneMaxLoadCapacityIsHigherThanCurrent() {
        Airport airport = new Airport(planes);
    ...
    @Test
    public final void testHasAtLeastOneBomberInMilitaryPlanes() {
        Airport airport = new Airport(planes);
    ...
    @Test
    public final void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified(){
        Airport airport = new Airport(planes);
